(() => {
  ...
  const diagnostics = { sourceCount: 0, fullDuration: 0, playDuration: 0, fraction: 0, style: "", lyricCues: 0 };
  ...
  function scheduleLyrics(blueprint, startAt, secondsPerBeat, playDuration, token, onLyric) {
  ...
  async function play(blueprint, options = {}) {
    ...
    scheduleLyrics(blueprint, startAt, secondsPerBeat, playDuration, token, options.onLyric);
    ...
    return { fullDuration, playDuration, fraction, sourceCount: diagnostics.sourceCount };
  }
